            ...
            <table class="border border-collapse w-full mt-5">
              <thead class="text-left">
                <tr>
                  ...
                  <th class="border pl-3 py-1">@sortablelink('birthday')</th>
                  <th class="border pl-3 py-1">@sortablelink('gender')</th>
              ...
              <tbody>
                @foreach ($users as $user)
                  <tr class="odd:bg-gray-100">
                    ...
                    <td class="border pl-3 py-1">{{ $user->location }}</td>
                    <td class="border pl-3 py-1">{{ $user->birthday?->toDateString() }}</td>
                    <td class="border pl-3 py-1">{{ $user->gender }}</td>
