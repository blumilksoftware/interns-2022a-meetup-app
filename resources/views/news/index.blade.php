  ...
  <div class="container md:w-[1216px] mx-auto mt-16 px-5 md:px-0">
    ...
    <div class="md:flex mt-3 text-white">
      <a href="#" class="w-1/2 relative">
        <img src="{{ asset('static/images/news_list.webp') }}" alt="news" class="w-full h-[450px] object-cover rounded-t-20 md:rounded-l-20 md:rounded-tr-none" />
        ...
        <div class="absolute w-full h-full inset-0 bg-gradient-to-t from-white to-black opacity-20 rounded-t-20 md:rounded-l-20 md:rounded-tr-none"></div>
      </a>
      <div class="md:w-1/2">
        <a href="#" class="w-1/2 relative">
          <div class="relative">
            <img src="{{ asset('static/images/news_list.webp') }}" alt="news" class="w-full h-[225px] object-cover md:rounded-tr-20" />
            ...
            <div class="absolute w-full h-full inset-0 bg-gradient-to-t from-white to-black opacity-20 md:rounded-tr-20"></div>
          </div>
        </a>
        <div class="flex">
          <a href="#" class="relative w-full">
            <img src="{{ asset('static/images/news_list.webp') }}" alt="news" class="w-full h-[225px] object-cover rounded-bl-20 md:rounded-bl-none" />
          ...
          <a href="#" class="relative w-full">
            <img src="{{ asset('static/images/news_list.webp') }}" alt="news" class="w-full h-[225px] object-cover rounded-br-20" />
            <div class="absolute bottom-0 z-10 px-5 py-3">
              <h3 class="text-lg font-bold leading-5">
                OpenAI is Making Coding As Easy As Talking to a Smart
                Speaker
              ...
              <div class="bg-white flex flex-wrap md:flex-nowrap gap-9 shadow-lg rounded-20 md:h-56">
                ...
                <div class="lg:w-[700px] px-8 pb-5 md:pb-0">
                  <h3 class="text-xl font-bold md:mt-10">
                    ...
                    <p class="text-gray-400 mt-5 break-all truncate">
