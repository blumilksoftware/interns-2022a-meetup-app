<nav class="bg-indigo-800" x-data="{ navOpened: false, userDropdownOpened: false }">
    ...
    <div class="relative flex items-center justify-between h-16">
      <div class="absolute inset-y-0 left-0 flex items-center lg:hidden">
        <button @click="navOpened = !navOpened" type="button" id="mobile-menu-button"
          class="inline-flex items-center justify-center p-2 rounded-md text-white hover:text-white hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white z-20"
  ...
  <div x-cloak x-show="navOpened" x-transition class="lg:hidden relative z-20" id="mobile-menu">
