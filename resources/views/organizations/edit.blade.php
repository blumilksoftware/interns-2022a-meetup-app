            ...
            <div>
                ...
                <div class="mt-6 flex flex-col gap-7">
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input type="text" name="name" id="name" placeholder="Name..." value="{{ old('name', $organization->name) }}"
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input type="text" name="organization_type" id="organization_type"
                                placeholder="Organization type..." value="{{ old('organization_type', $organization->organizationType) }}"
                                class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" />
